...
def parse_station_id(fname):
    # Exemplos: INMET_CO_DF_A001_BRASILIA_01-01-2024_A_31-12-2024.CSV
...
for idx, fname in enumerate(files, 1):
    ...
    for r in data_rows:
        ...
        # parse data: pode vir "2024/01/01" ou "01/01/2024"
        dt = None
